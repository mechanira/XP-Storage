...
public class OmegaXPBottleEntity extends ThrownItemEntity {
    public OmegaXPBottleEntity(EntityType<? extends SuperXPBottleEntity> entityType, World world) {
        super(entityType, world);
    }

    public OmegaXPBottleEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntityType.EXPERIENCE_BOTTLE, owner, world, stack);
    }

    public OmegaXPBottleEntity(World world, double x, double y, double z, ItemStack stack) {
